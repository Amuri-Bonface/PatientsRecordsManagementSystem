...
Public Class Ripoti_Diagnosis
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PatientRecordManagementSystem.Ripoti_Diagnosis.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRipoti_Diagnosis
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Ripoti_Diagnosis = New Ripoti_Diagnosis()
        rpt.Site = Me.Site
        Return rpt
    End Function
