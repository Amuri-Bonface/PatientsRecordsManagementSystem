...
Public Class Ripoti_staff
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PatientRecordManagementSystem.Ripoti_staff.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRipoti_staff
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Ripoti_staff = New Ripoti_staff()
        rpt.Site = Me.Site
        Return rpt
    End Function
