...
Public Class Ripoti_Billing
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PatientRecordManagementSystem.Ripoti_Billing.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRipoti_Billing
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Ripoti_Billing = New Ripoti_Billing()
        rpt.Site = Me.Site
        Return rpt
    End Function
