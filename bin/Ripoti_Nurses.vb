...
Public Class Ripoti_Nurses
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PatientRecordManagementSystem.Ripoti_Nurses.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRipoti_Nurses
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Ripoti_Nurses = New Ripoti_Nurses()
        rpt.Site = Me.Site
        Return rpt
    End Function
