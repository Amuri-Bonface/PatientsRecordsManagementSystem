...
Public Class Ripoti_Doctors
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PatientRecordManagementSystem.Ripoti_Doctors.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRipoti_Doctors
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Ripoti_Doctors = New Ripoti_Doctors()
        rpt.Site = Me.Site
        Return rpt
    End Function
