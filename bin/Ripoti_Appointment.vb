...
Public Class Ripoti_Appointment
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PatientRecordManagementSystem.Ripoti_Appointment.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRipoti_Appointment
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Ripoti_Appointment = New Ripoti_Appointment()
        rpt.Site = Me.Site
        Return rpt
    End Function
