...
Public Class Ripoti_Wards
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PatientRecordManagementSystem.Ripoti_Wards.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRipoti_Wards
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Ripoti_Wards = New Ripoti_Wards()
        rpt.Site = Me.Site
        Return rpt
    End Function
