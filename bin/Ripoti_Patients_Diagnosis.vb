...
Public Class Ripoti_Patients_Diagnosis
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Ripoti_Patients_Diagnosis.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PatientRecordManagementSystem.Ripoti_Patients_Diagnosis.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRipoti_Patients_Diagnosis
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Ripoti_Patients_Diagnosis = New Ripoti_Patients_Diagnosis()
        rpt.Site = Me.Site
        Return rpt
    End Function
